...
public class AccountPage {
    ...
    private final By textAboutPersonalAccount = By.xpath("//p[text()='В этом разделе вы можете изменить свои персональные данные']");
    ...
    public void isDisplayedInfoAboutPersonalAccount() {
        Assert.assertTrue(driver.findElement(textAboutPersonalAccount).isDisplayed());
    }
